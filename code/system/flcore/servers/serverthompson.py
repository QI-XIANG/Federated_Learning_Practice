...
class ThompsonSampling:
    def __init__(self, num_clients, prior_alpha=1, prior_beta=1):
    ...
    def select_clients(self, num_selections):
        ...
        _, selected_clients = torch.topk(samples, num_selections)
...
class FedThompson(Server):
    ...
    def train(self):
        ...
        with mlflow.start_run(run_name = "noniid_wbn_2_contribution"):
            ...
            for i in range(self.global_rounds+1):
                ...
                rewards = clients_acc
                ts.update(selected_clients, rewards)
